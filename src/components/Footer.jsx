...
function Footer(props) {
  ...
  const resumeLink =
    "https://docs.google.com/document/d/1XRXuKHKSs5A1Kh2XkxHu-qxJpbrd527_ug9ycvp7u2o/edit?usp=sharing";
          ...
          <Grid container>
            ...
            >
              <Typography variant="body1">
                Contact me at{" "}
                <a
                  href="mailto:woodward.michael.a@gmail.com"
                  style={{ color: "#ddd", textDecoration: "none" }}
                >
                  woodward.michael.a@gmail.com
                </a>
              </Typography>
            </Grid>
            ...
            <Grid item md={12} p={2} textAlign={{ sm: "center", md: "center" }}>
              <Typography variant="body1">{props.copyright}</Typography>
            </Grid>
          </Grid>
        </div>
      </Box>
